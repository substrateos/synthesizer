  ...
  },
  {
    ...
    "returns": {
      "solutions": {
        ...
        "ground_unbound_rest": [{"Obj": {"a": 99, "b": 2, "d": 4}, "R1": {"$var": "R1"}}]
      }
    }
  },
  {
    ...
    "params": [
      {
        "source": `
          ...
          // This tests back-propagation of bindings to R1.
          function test_complex_unify(R1, P_out) {
            var P;
            make_complex_pattern(R1, {f: 6, b: 99}, P);
            P = {a: 1, e: 5, b: 2, f: 6, c: 3};
            P_out = P;
          }
        `,
        "queries": {
          ...
          "complex_unify_pattern_vs_value": {
            "test_complex_unify": [{"$var": "R1"}, {"$var": "P"}]
          }
        }
      }
    ],
    ...
    "returns": {
      "solutions": {
        "simple_unify_pattern_vs_value": [{"A": 1, "T": {"b": 2, "c": 3}, "P": {"a": 1, "b": 2, "c": 3}}],
        "complex_unify_pattern_vs_value": [{"R1": {"e": 5, "f": 6, "c": 3}, "P": {"a": 1, "e": 5, "f": 6, "c": 3, "b": 99}}]
      }
    }
  },
  {
    ...
    "throws": {
      "name": "Error",
      "message": "Cannot ground ObjectPattern: rest variable 'T' was bound to non-object."
    }
  },
  {
