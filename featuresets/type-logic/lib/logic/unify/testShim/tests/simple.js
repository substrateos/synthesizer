...
export default [
  ...
  {
    "description": "7.1: Transitive Resolution and Trace Aggregation",
    "params": [
      {
        "term1": { "$var": "X" },
        "term2": { "$var": "Z" },
        "bindings": {
          "X": {
            "value": { "$var": "Y" },
            "trace": [
              { "type": "BIND", "variable": { "$var": "X" }, "value": { "$var": "Y" }, "location": { "rule": "7.1-A" } }
            ]
          },
          "Y": {
            "value": "resolved",
            "trace": [
              { "type": "BIND", "variable": { "$var": "Y" }, "value": "resolved", "location": { "rule": "7.1-B" } }
            ]
          }
        },
        "location": { "rule": "7.1-C" }
    ...
    "returns": {
      ...
      "Z": {
        "value": "resolved",
        "trace": [
          { "type": "BIND", "variable": { "$var": "Z" }, "value": "resolved", "location": { "rule": "7.1-C" } },
          { "type": "BIND", "variable": { "$var": "X" }, "value": { "$var": "Y" }, "location": { "rule": "7.1-A" } },
          { "type": "BIND", "variable": { "$var": "Y" }, "value": "resolved", "location": { "rule": "7.1-B" } }
        ]
      }
