 ...
 * @param {object} startLocation - { line, column } for debugging.
 */
export default ({ target, rawString, paramNames, argValues, startLocation }) => {
    ...
    switchExpr('oppc', [
      ...
      [1,
        ...
        unifyExpr({
          ...
          startLocation,
          successExpr: [
            // Cleanup local state on success (unifyExpr handles pc++)
            `oppc = undefined;`,
          ],
        }),
        e => e.break()],
